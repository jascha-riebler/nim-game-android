...
public class Nimclassic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int a=1; a<5; a++){
            for(int b=1; b<8; b++){
                ...
                int resid = Nimclassic.this.getResources().getIdentifier(checkboxid,"id",Nimclassic.this.getPackageName());
    ...
    private void getComputerMove(){
        ...
        if(computerboard[0]==0 && computerboard[1]==0 && computerboard[2]==0 && computerboard[3]==0){
            ...
            mEditor.commit();
            final Intent NimclassicToExit = new Intent(this,Nimclassic_exit.class);
            startActivity(NimclassicToExit);
            return;
        }
